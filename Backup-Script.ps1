########################################################
#scription: Copies the Bakupdirs to the Destination
# 
########################################################

#Variables, only Change here
$Destination="E:\_Backup" #Copy the Files to this Location
$Versions="50" #How many of the last Backups you want to keep
$BackupDirs="C:\Users\or0002122","C:\Scotts", "C:\Jira_Scripts" #What Folders you want to backup
